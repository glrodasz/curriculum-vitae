 ...
 */
export const updateManifestTheme = (isDarkMode) => {
 ...
 */
const updateThemeColorMeta = (color) => {
 ...
 */
const updateManifestContent = async (colors) => {
  try {
 ...
 */
export const initializeManifestTheme = () => {
